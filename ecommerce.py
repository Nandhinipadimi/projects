...
#year over year=(curr sales-prev sales/prev sales).
...
#4. Calculate the retention rate of customers, defined as the percentage of customers who make another purchase within 6 months of their first purchas
...
cur.execute(query)
data=cur.fetchall()
print(data) #no reapeted customers ,so that the output  is none
